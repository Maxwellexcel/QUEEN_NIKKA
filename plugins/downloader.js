...
smd({
 ...
 cmd({
   ...
   if (_0xb75e78.quoted && _0xb75e78.text) {
     ...
     if (_0x5b8ee5[0].includes("Queen_NIKKA • sᴏɴɢ ᴅᴏᴡɴʟᴏᴀᴅᴇʀ")) {
     ...
     } else if (_0x5b8ee5[0].includes("QUEEN_NIKKA • ʏᴏᴜᴛᴜʙᴇ ᴅᴏᴡɴʟᴏᴀᴅ")) {
     ...
     } else if (_0x5b8ee5[0].includes("QUEEN_NIKKA • ᴀᴘᴋ ᴅᴏᴡɴʟᴏᴀᴅ ʟɪsᴛ")) {
